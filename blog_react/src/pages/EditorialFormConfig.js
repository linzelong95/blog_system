...
const getEditor = ({ stateName = "editorValue", value, handleSetState, ...otherProps }) =>
  <CustomEditor value={value} onChange={(val) => handleSetState({ [stateName]: val })} {...otherProps} />;
...
const EditorialFormConfig = { getUpload, getEditor, getModalForm, getList, searchItem, getSelectorConfig, onHandleCustomTableChange, getCommonSelectedTable, getIconfont };
