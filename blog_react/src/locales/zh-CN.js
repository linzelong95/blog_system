export default {
  ...
  'menu.commoditymanagement.insellinggoods': '商品详情',
  'menu.commoditymanagement.brandmanagement': '品牌管理',
  'menu.commoditymanagement.commodityseries': '商品系列',
  'menu.commoditymanagement.categoryattribute': '分类属性',
  'menu.commoditymanagement.attributemanagement': '属性管理',
  'menu.commoditymanagement.attributevaluemanagement': '属性值管理',
  'menu.BasicDataManagement': '数据管理',
  'menu.BasicDataManagement.BasicCategory': '基础分类',
  'menu.BasicDataManagement.Unit': '单位',
  'menu.BasicDataManagement.UnitConvert': '单位换算',
  'menu.ordermanagement': '订单管理',
  'menu.ordermanagement.orderlist': '订单详情',
  'menu.ordermanagement.afterservice': '售后服务',
  'menu.marketingmanagement': '营销管理',
  'menu.marketingmanagement.coupon': '优惠券',
  'menu.marketingmanagement.timelimitpurchase': '限时购',
  'menu.marketingmanagement.grouppurchase': '团购',
  'menu.marketingmanagement.promotionpurchase': '促销购',
  'menu.marketingmanagement.specialprice': '特价',
  'menu.marketingmanagement.commoditycombination': '组合购',
  'menu.messagemanagement': '消息管理',
  'menu.messagemanagement.letter': '站内信',
  'menu.messagemanagement.commodityevaluation': '商品评价',
  'menu.distributionmanagement': '物流管理',
  'menu.distributionmanagement.warehouse': '仓库',
  'menu.distributionmanagement.express': '快递',
  'menu.distributionmanagement.distributiontemplate': '配送模板',
  'menu.distributionmanagement.distributionmode': '配送方式',
  'menu.permissionmanagement': '权限管理',
  'menu.permissionmanagement.role': '角色管理',
  'menu.permissionmanagement.authorize': '授权管理',
  'menu.permissionmanagement.managerlog': '管理日志',
